 ...
 * @category models
 */
export type Middleware<R> = R extends NextServerComponent<infer _Tag, infer _Runtime, infer _Middleware>
...
export type ExtractProvides<R extends Any> = R extends
  NextServerComponent<infer _Tag, infer _Runtime, infer _Middleware>
 ...
 * @category models
 */
export type ToHandler<R extends Any> = R extends NextServerComponent<infer _Tag, infer _Runtime, infer _Middleware> ?
  Handler<_Tag>
  : never
